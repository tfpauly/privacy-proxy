...
By default client use the standard port for HTTP over TLS, 443 and ".well-known/pvd" path;
however, both the port and the path MAY be overriden by local policy.
